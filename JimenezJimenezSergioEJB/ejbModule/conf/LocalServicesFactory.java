...
public class LocalServicesFactory implements ServicesFactory{
	...
	private static final String ALUMNOS_SERVICE_JNDI_KEY = 
			...
			+ "AlumnosServiceImpl!"
			+ "business.impl.ejbinterfaces.AlumnosServiceLocal";
	...
	private static final String USER_SERVICE_JNDI_KEY = 
			...
			+ "JimenezJimenezSergioEJB/"
			+ "UserServiceImpl!"
			+ "business.impl.ejbinterfaces.UserServiceLocal";
	...
	private static final String ADMIN_SERVICE_JNDI_KEY = 
			...
			+ "JimenezJimenezSergioEJB/"
			+ "AdminServiceImpl!"
			+ "business.impl.ejbinterfaces.AdminServiceLocal";
	...
	private static final String PROFESOR_SERVICE_JNDI_KEY = 
			...
			+ "JimenezJimenezSergioEJB/"
			+ "ProfesorServiceImpl!"
			+ "business.impl.ejbinterfaces.ProfesorServiceLocal";
	...
	private static final String ASIGNATURAS_SERVICE_JNDI_KEY = 
			...
			+ "business.impl.ejbinterfaces.AsignaturasServiceLocal";
	...
	private static final String MATRICULADOS_SERVICE_JNDI_KEY = 
			...
			+ "business.impl.ejbinterfaces.MatriculadosServiceLocal";
